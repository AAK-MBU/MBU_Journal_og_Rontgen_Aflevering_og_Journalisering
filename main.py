...
from processes.subprocesses.reset.clean_up import (
            ...
            try:
                with item:
                    ...
                    try:
                        ...
                        # Context handler: automatically resets shared context before and after processing each item.
                        with Scope():
                            process_item(data, item_id)
